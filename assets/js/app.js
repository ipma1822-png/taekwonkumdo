...
// WTKF WORLD HUB v3.3.0 — mobile-first LIVE showroom entry layer.
...
(function(){
  ...
  style.id='wtkfhub-live-style-v330';
  style.textContent=`
  ...
  section.innerHTML=`<div class="wtkfhub-wrap">
    <div class="wtkfhub-copy">
      ...
      <div class="wtkfhub-share"><button type="button" data-wtkfhub-share>↗ 이 페이지 공유</button><span class="wtkfhub-version">WORLD HUB v3.3.0 · 기존 HQ 시스템 유지</span></div>
    </div>
  ...
  modal.innerHTML=`<div class="wtkfhub-modalbox" role="dialog" aria-modal="true" aria-label="30초 태권검도 체험">
    ...
    <div class="wtkfhub-modalactions"><a href="#wtkfhub-tech">공식 기술영상 보기 →</a><a href="./program/">교육과정 보기 →</a><a href="./contact/">지도자 참여 →</a></div>
  </div>`;
  document.body.appendChild(modal);
  let tourTimers=[];
